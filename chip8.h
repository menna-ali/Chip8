...
// Chip8
	...
	private:	
		...
		unsigned short opcode;			// Current opcode: chip 8 has 35 opcodes, each is two bytes long, hence unsugned short is used
		unsigned short I;				// Index register
		unsigned short sp;				// Stack pointer
		
		unsigned char  V[16];			// V-regs (V0-VF): 15 general purpose registers and one carry flag register
